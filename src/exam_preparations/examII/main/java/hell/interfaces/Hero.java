package exam_preparations.examII.main.java.hell.interfaces;
...
public interface Hero {
    ...
    Collection<Item> getItems() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException;
